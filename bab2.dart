...
class ProdukDigital {
  ...
  void terapkanDiskon(int jumlahTerjual) {
    if (kategori == "NetworkAutomation" && jumlahTerjual > 50) {
      double hargaSebelumDiskon = harga; // Simpan harga sebelum diskon
      double hargaDiskon = harga * 0.85;
      harga = (hargaDiskon < 200000) ? 200000 : hargaDiskon;
      print("Harga sebelum diskon: Rp ${hargaSebelumDiskon.toStringAsFixed(0)}");
      print("Harga setelah diskon: Rp ${harga.toStringAsFixed(0)}");
    } else {
